...
With libtwobitxml user no longer needs to concentrate on the binding between XML source data and native program data. around every node fetch, whereas 
...
Generated file visualised with "XDot":https://code.google.com/p/jrfonseca/wiki/XDot
...
*  "libiconv":http://www.gnu.org/s/libiconv/  - GNU software's conversion routines for text transformation etc.
